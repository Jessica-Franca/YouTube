...
| 4 | LOOP com data (ETL) | [`SQL_LOOP_Data.sql`](./Aulas_Avulsas/SQL_LOOP_Data.sql) | [Assistir](https://youtu.be/Z4tMiRvUgJY) |
| 5 | LEFT JOIN | [`SQL_LEFT_JOIN.sql`](./Aulas_Avulsas/SQL_LEFT_JOIN.sql) | [Assistir](https://youtu.be/GmL4jGSuOPU) |
